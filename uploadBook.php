...
if($result = mysql_query($sql))
{
        ...
        <div id="page-wrapper">
            ...
            <div class="row">
                <!-- Page Header -->
                <div class="col-lg-12">
                    <h1 class="page-header">Upload Book </h1>
                </div>
                <!--End Page Header -->
            </div>
<div class="row">
                    ...
                    <div class="chat-panel panel panel-primary">
                        ...
                        <div class="panel-footer">
                            <div class="input-group">
                                ...
                                <form role="form" action="saveBook.php"   enctype="multipart/form-data" method="post">
                            <fieldset>
                                <div class="form-group">
                                    <input class="form-control" placeholder="Name" name="name" type="text" required  autofocus>
                                </div>
                                <div class="form-group">
                                    <input class="form-control" placeholder="Author" name="author" type="text" required  autofocus>
                                </div>
                                   <div class="form-group">
                                       <input class="form-control" placeholder="Amount" name="amt"  required type="number" >
                                </div>
                       
                                            <div class="form-group">
                                       <input class="form-control"  name="im"  required type="file" >
                                </div>
