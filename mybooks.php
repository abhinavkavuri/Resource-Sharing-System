...
<?php
 ...
 $sql = "SELECT * FROM books where takenBy='".$_SESSION["uid"]."' and status=1";
if($result = mysql_query($sql))
{
            ...
            <div class="row">
                ...
                <div class="col-lg-3">
                    <div class="alert alert-danger text-center">
                      <?php echo "<img widthd='100' height='100' src='data:image/png;base64,".base64_encode($row["imgData"])."' />";?> &nbsp;
                        <br>
                            <?php echo $row["name"]; ?></t<br><?php echo $row["author"]; ?><br>
                                <?php echo "Amount =".$row["amount"]; ?><br>
                                    <?php echo "Owner =".$row["owner"]; ?><br>
       <?php echo "<a href=return.php?id=".$row["id"].">Return</a>";     ?>                             
                </div>
